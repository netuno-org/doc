...
#### _cron.schedule(chave: string, config: string, url: string) : [Cron](/docs/library/resources/cron)
##### Descrição
...
#### _cron.schedule(chave: string, config: string, url: string, params: [Values](/docs/library/objects/Values)) : [Cron](/docs/library/resources/cron)
##### Descrição
...
#### _cron.schedules() : [Values](/docs/library/objects/Values)
##### Descrição
