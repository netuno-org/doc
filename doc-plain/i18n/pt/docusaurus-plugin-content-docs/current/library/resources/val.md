...
#### _val.fromJSON(texto: string) : [Values](/docs/library/objects/Values)
##### Descrição
...
#### _val.list(valores: [Values](/docs/library/objects/Values)) : java.util.List
##### Descrição
...
#### _val.map(valores: java.lang.Object) : [Values](/docs/library/objects/Values) &#124; [DataSchema](/docs/library/objects/DataSchema) | java.util.Map
##### Descrição
...
#### _val.map(valores: [Values](/docs/library/objects/Values)) : [Values](/docs/library/objects/Values) &#124; [DataSchema](/docs/library/objects/DataSchema) | java.util.Map
##### Descrição
...
#### _val.toJSON(valores: [Values](/docs/library/objects/Values)) : string
##### Descrição
...
#### _val.toJSON(valores: [Values](/docs/library/objects/Values), emHTML: boolean) : string
##### Descrição
...
#### _val.toJSON(valores: [Values](/docs/library/objects/Values), emHTML: boolean, indentacao: int) : string
##### Descrição
...
#### _val.toJSON(valores: [Values](/docs/library/objects/Values), indentacao: int) : string
##### Descrição
...
#### _val.toList(valores: [Values](/docs/library/objects/Values)) : java.util.List
##### Descrição
...
#### _val.toMap(valores: java.lang.Object) : [Values](/docs/library/objects/Values) &#124; [DataSchema](/docs/library/objects/DataSchema) | java.util.Map
##### Descrição
...
#### _val.toMap(valores: [Values](/docs/library/objects/Values)) : [Values](/docs/library/objects/Values) &#124; [DataSchema](/docs/library/objects/DataSchema) | java.util.Map
##### Descrição
