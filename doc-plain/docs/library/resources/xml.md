...
#### _xml.nodeType(type: string) : short
##### Description
...
#### _xml.output(document: org.w3c.dom.Document) : void
##### Description
...
#### _xml.output(document: org.w3c.dom.Document, fileName: string) : void
##### Description
...
#### `_xml.create()`.parse(inputStream: [InputStream](/docs/library/objects/InputStream)) : org.w3c.dom.Document
##### Description
...
#### `_xml.create()`.parse(content: string) : org.w3c.dom.Document
##### Description
...
#### `_xml.create()`.parse(content: string, charset: string) : org.w3c.dom.Document
##### Description
...
#### `_xml.create()`.parse(file: [File](/docs/library/objects/File)) : org.w3c.dom.Document
##### Description
...
#### _xml.save(document: org.w3c.dom.Document, outputStream: [OutputStream](/docs/library/objects/OutputStream)) : void
##### Description
...
#### _xml.save(document: org.w3c.dom.Document, file: [File](/docs/library/objects/File)) : void
##### Description
...
#### _xml.save(document: org.w3c.dom.Document, storage: [Storage](/docs/library/resources/storage)) : void
##### Description
...
#### _xml.toString(document: org.w3c.dom.Document) : string
##### Description
