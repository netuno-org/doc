...
#### _cron.schedule(key: string, config: string, url: string) : [Cron](/docs/library/resources/cron)
##### Description
...
#### _cron.schedule(key: string, config: string, url: string, params: [Values](/docs/library/objects/Values)) : [Cron](/docs/library/resources/cron)
##### Description
