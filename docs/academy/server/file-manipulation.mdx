...
To write the data to the `output`, we use the [printAndClose](/docs/library/objects/OutputStream#printandclose) method, which prints the content to the file and closes the file, saving the content.
...
So with `OutputStream` the method [printAndClose](/docs/library/objects/OutputStream#printandclose),
