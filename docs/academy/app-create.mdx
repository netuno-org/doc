...
Creating a new fullstack application on the platform.
...
Let's create the `📂 client` folder and the following `pdf-export` code file, use the respective extension of your
