...
A browser-based notification manager that integrates the [Push API](https://developer.mozilla.org/en-US/docs/Web/API/Push_API) and uses [Web Push](https://github.com/interaso/webpush).
