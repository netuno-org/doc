...
O nome do novo ficheiro deverá ser:

<PolyglotPath files={[
    'server/services/trabalhadores'
]} />

Vamos criar um serviço em <a href="https://developer.mozilla.org/pt-BR/docs/Web/JavaScript" target="_blank">JavaScript</a>.
