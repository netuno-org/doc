...
Vamos criar a pasta `📂 cliente` e o seguinte arquivo de código `exporta-pdf`, utilize a respectiva extensão
da linguagem de backend que é a sua preferência, como:
...
Utilize o seguinte código para gerar o arquivo PDF:
