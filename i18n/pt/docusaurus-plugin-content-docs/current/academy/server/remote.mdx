    ...
    codes={[
        {
            lang: 'javascript',
            code: `
                const download = _remote.init().asBinary()
        ...
        },
        {
            lang: 'python',
            code: `
                download = _remote.init().asBinary().get(
        ...
        },
        {
            lang: 'kotlin',
            code: `
                val download = _remote.init().asBinary().get(
                    "https://raw.githubusercontent.com/netuno-org/platform/main/docs/images/overview.png"
                );
    ...
    codes={[
        {
            ...
            code: `
                ...
                const upload = _remote.init().asMultipartFormData()
                  .post(
        ...
        },
        {
            ...
            code: `
                ...
                upload = _remote.init().asMultipartFormData().post(
                    "http://localhost:9000/services/file-receiver",
        ...
        },
        {
            ...
            code: `
                ...
                val upload = _remote.init().asMultipartFormData().post(
                    "http://localhost:9000/services/file-receiver",
                    _val.map().set("file", file)
                );
