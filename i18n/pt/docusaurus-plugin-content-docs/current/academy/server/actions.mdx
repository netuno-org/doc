...
- `_db.insert(...)`, `_db.form(...).insert()`, `_db.insertIfNotExists(...)`, `_db.insertMany(...)`, entre outros.
- `_db.update(...)`, `_db.form(...).update()`, `_db.updateMany(...)`, entre outros.
- `_db.delete(...)`, `_db.form(...).delete()`, `_db.deleteMany(...)`, entre outros.
...
> Veja a documentação do recurso [DataItem](/docs/library/resources/dataItem) para saber mais detalhes sobre o que
...
<PolyglotPath files={[
    'minha_app/server/actions/meu_formulario/save'
]} />
...
<PolyglotPath files={[
    'minha_app/server/actions/meu_formulario/saved'
]} />
...
<PolyglotCode
    file="minha_app/server/actions/meu_formulario/save"
    codes={[
        {
            lang: 'javascript',
            code: `
...
<PolyglotCode
    file="minha_app/server/actions/meu_formulario/saved"
    codes={[
        {
            lang: 'javascript',
            code: `
...
<PolyglotPath files={[
    'minha_app/server/actions/meu_formulario/setup_save',
    'minha_app/server/actions/meu_formulario/setup_saved',
]} />
...
<PolyglotPath files={[
    'minha_app/server/actions/meu_formulario/setup_remove',
]} />
...
<PolyglotPath files={[
    'minha_app/server/actions/meu_formulario/setup_removed',
]} />
...
<PolyglotCode
    file="minha_app/server/actions/meu_formulario/removed"
    codes={[
        {
            lang: 'javascript',
            code: `
...
<PolyglotCode
    file="minha_app/server/actions/meu_formulario/remove"
    codes={[
        {
            lang: 'javascript',
            code: `
